...
public enum FileSystemCode implements ResultCode {
    ...
    FS_DELETEFILE_SERVERFAILTRUE(true,25014,"删除文件不存在,请重新上传！"),
    FS_UPLOADFILE_METAERROR(false,25007,"上传文件的元信息请使用json格式！"),
    FS_UPLOADFILE_USERISNULL(false,25008,"上传文件用户为空！"),
    FS_INITFDFSERROR(false,25010,"文件初始化失败"),
    FS_UPLOADFILE_SUCCESS(true,25011,"上传文件成功"),
    FS_UPLOADFILE_FILE(false,25012,"上传文件失败"),
    FS_DELETEFILE_SUCCESS(true,25013,"删除文件成功");
