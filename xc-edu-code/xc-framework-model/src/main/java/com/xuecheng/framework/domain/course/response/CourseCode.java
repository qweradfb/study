...
public enum CourseCode implements ResultCode {
    ...
    COURSE_MEDIS_ISNULL(false,31110,"媒资文件为空！"),
    COURSE_MEDIS_NAMEISNULL(false,31102,"选择的媒资文件名称为空！"),
    COURSE_NOTFIND(false,32000,"该课程不存在！"),
    COURSE_MARKETISNULL(false,32001,"课程营销不能为空"),
    COURSE_CREATECOURSEINDEXFAIL(false,32222,"创建课程索引失败"),
    TEACHPLAN_ISNULL(false,32002,"课程计划不能为空"),
    TEACHPLANMEDIA_ISNULL(false,36001,"课程计划媒体信息为空"),
    TEACHPLAN_MISMATCHING(false,36002,"课程计划等级必须是三");
    //操作代码
